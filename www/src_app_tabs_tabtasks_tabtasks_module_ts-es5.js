  ...
  (self["webpackChunksheriff"] = self["webpackChunksheriff"] || []).push([["src_app_tabs_tabtasks_tabtasks_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "TabTasksPageModule": function TabTasksPageModule() {
          return (
            /* binding */
            _TabTasksPageModule
          );
      ...
      var _tabtasks_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./tabtasks.page */
      58746);
      /* harmony import */


      var _directives_directives_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _TabTasksPageModule = function TabTasksPageModule() {
        _classCallCheck(this, TabTasksPageModule);
      };

      _TabTasksPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _angular_router__WEBPACK_IMPORTED_MODULE_7__.RouterModule.forChild(routes), ng_circle_progress__WEBPACK_IMPORTED_MODULE_8__.NgCircleProgressModule.forRoot(), _directives_directives_module__WEBPACK_IMPORTED_MODULE_1__.DirectivesModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "TabTasksPage": function TabTasksPage() {
          return (
            /* binding */
            _TabTasksPage
          );
      ...
      var _raw_loader_tabtasks_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./tabtasks.page.html */
      46382);
      /* harmony import */


      var _tabtasks_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./tabtasks.page.scss */
      71086);
      /* harmony import */
      ...
      var src_app_services_datetime_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var src_app_services_deputy_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/services/deputy.service */
      22092);
      /* harmony import */


      var src_app_modals_detail_task_add_task_add_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/modals/detail/task-add/task-add.page */
      81900);
      /* harmony import */
      ...
      var _TabTasksPage = /*#__PURE__*/function () {
        ////////////////////////////////////////////////////////////////////////////////////////
        function TabTasksPage(plt, router, logger, modalCtrl, sqlServ, syncServ, evServ, deputy, dT, detailServ) {
          _classCallCheck(this, TabTasksPage);
          ...
          this.preventRefreshPull = false; // Task List/Data/DB
          ...
          this.totalAssTasksDone = 0; // Tasks Segment/Buttons
          ...
          this.tTReorderGroupProps = {
            roDisabled: true
          };
          this.beforeROIds = [];
          this.afterROIds = []; // Delete Mode

          this.deleteMode = false; // Add Task

          this.addTaskModalOpts = {
            animated: false,
            showBackdrop: false,
            backdropDismiss: false,
            cssClass: 'tsheet-detail-modal-class',
            component: src_app_modals_detail_task_add_task_add_page__WEBPACK_IMPORTED_MODULE_8__.TaskAddPage,
            keyboardClose: true
          };
          this.addTaskModalOpen = false; // Task Prog

          this.taskProg = false; // Doofy

          this.assignToSelectAlertOpts = {
            cssClass: 'quickSelectClass',
            header: 'Assign Task To'
          };
        ...
        _createClass(TabTasksPage, [{
          ...
          value: function ionViewWillEnter() {
            this.logger.info('[TabTasks|ionViewWillEnter] ()...');
          } ////////////////////////////////////////////////////////////////////////////////////////
          ...
          value: function ionViewDidEnter() {
            ...
            this.evServ.subscribe('alertsStatus', function () {
              _this.evServ.subscribe('alertsStatus', function () {
                _this.initAlertOpts();
              });
            });
          } ////////////////////////////////////////////////////////////////////////////////////////
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                          ...
                          return regeneratorRuntime.wrap(function _callee4$(_context4) {
                            while (1) {
                              switch (_context4.prev = _context4.next) {
                                case 0:
                                  _context4.next = 2;
                                  return this.syncServ.doTasksSync('init');
                    ...
                    case 5:
                      this.dbTaskItems = [];
                      _context5.next = 8;
                      return this.syncServ.doTasksSync('refresh');
          ...
          value: function fetchTasks() {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_11__.__awaiter)(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
              var getAllTasksRes, locAllTs, sortdAllTs, i, _i;
              ...
              return regeneratorRuntime.wrap(function _callee6$(_context6) {
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    ...
                    case 3:
                      getAllTasksRes = _context6.sent;
                      console.log(getAllTasksRes.values);

                      if (getAllTasksRes.values.length > 0) {
                        locAllTs = getAllTasksRes.values;
                        sortdAllTs = lodash__WEBPACK_IMPORTED_MODULE_10__.sortBy(locAllTs, 'SortOrder');

                        for (i = 0; i < sortdAllTs.length; i++) {
                        ...
                        for (_i = 0; _i < this.tLists.length; _i++) {
                          this['total' + this.tLists[_i]] = 0;
                        }
                      }
          ...
          key: "formatTask",
          value: function formatTask(rawTaskObj) {
            ...
            var uEntryArr = this.myPpl.filter(function (p) {
              return p.EmpId === rTO.UserEntry;
            });
            ...
            ;
            var uAssignedArr = this.myPpl.filter(function (p) {
              return p.EmpId === rTO.UserResponsible;
            });

            if (uAssignedArr.length > 0) {
              var _pO = uAssignedArr[0];

              if (_pO.EmpId === this.meEmpId) {
                rTO['nAssigned'] = 'You';
              } else {
                if (_pO.FirstName.length > 0 && _pO.LastName.length > 0) {
                  rTO['nAssigned'] = _pO.FirstName + ' ' + _pO.LastName.charAt(0) + '.';
                } else {
                  _pO.DisplayName.length > 0 ? rTO['nAssigned'] = _pO.DisplayName : rTO['nAssigned'] = 'NK';
                }
              }

              ;
              rTO['nAssignedAvatar'] = _pO.Photo;
            } else {
              rTO['nAssigned'] = 'NK';
            ...
            ;
            var createD = new Date(rTO.Created);
            ...
            if (rTO.DueTimestamp !== -1 && rTO.DueTimestamp !== null && rTO.DueTimestamp !== undefined && rTO.DueTimestamp !== '') {
              var dueD = this.dT.Dut(rTO.DueTimestamp);
              rTO['nDue'] = this.dT.format(dueD, 'EEE, d MMM yyyy');
              var nowUT = this.dT.getUT(new Date());
            ...
            if (rTO.TsCompleted === -1 || rTO.TsCompleted === null || rTO.TsCompleted === undefined || rTO.TsCompleted === '') {
              ...
              var compD = this.dT.Dut(rTO.TsCompleted);
          ...
          key: "updateListCounts",
          value: function updateListCounts() {
            this.logger.info('[TabTasks|updateListCount] ()...');

            for (var i = 0; i < this.tLists.length; i++) {
              var lN = this.tLists[i].charAt(0).toLowerCase() + this.tLists[i].slice(1);
              var tLNo = this[lN].length;
          ...
          key: "tTSegChanged",
          value: function tTSegChanged(ev) {
          ...
          key: "refreshTasksData",
          value: function refreshTasksData() {
                ...
                while (1) {
                  switch (_context8.prev = _context8.next) {
                    case 0:
                      ...
                      this.evServ.subscribe('refreshTasksProg', function () {
                        rStage += 25;

                        _this4.logger.info('[TabTasks|refreshTasksData] (PROGRESS STAGE TRIGGER) STAGE #' + rStage);

                        if (rStage < 100) {
                          _this4.headerProgress('manual', 'change', rStage);
                        } else {
                          _this4.evServ.destroy('refreshTasksProg');

                          _this4.headerProgress('manual', 'finish', null);
                        }
                      });
                      setTimeout(function () {
                        _this4.syncServ.doTasksSync('refresh');
                      }, 250);
          ...
          key: "changeCheckStatus",
          value: function changeCheckStatus(list, index, tO) {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_11__.__awaiter)(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
              ...
              var opTxt, nKeys, duTRes, duT, i, trimList;
                ...
                while (1) {
                  switch (_context10.prev = _context10.next) {
                    case 0:
                      ...
                      nKeys = ['nCreated', 'nDue', 'nIsLate', 'nIsDone', 'nCompleted'];

                      duTRes = function duTRes() {
                        return (0, tslib__WEBPACK_IMPORTED_MODULE_11__.__awaiter)(_this5, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
                          var undRes, dRes;
                            ...
                            while (1) {
                              switch (_context9.prev = _context9.next) {
                                case 0:
                                  ...
                                  opTxt = 'TO DO';
                                  _context9.next = 4;
                                  return this.deputy.undoTask(tO.Id, tO.UserResponsible);

                                case 4:
                                  undRes = _context9.sent;
                                  return _context9.abrupt("return", Promise.resolve(undRes));

                                case 8:
                                  opTxt = 'COMPLETED';
                                  _context9.next = 11;
                                  return this.deputy.doTask(tO.Id, tO.UserResponsible);

                                case 11:
                                  dRes = _context9.sent;
                                  return _context9.abrupt("return", Promise.resolve(dRes));
                    ...
                    case 8:
                      ...
                      if (duT.result) {
                        ...
                        ;
                        trimList = this[list].filter(function (t) {
                          return t.Id !== tO.Id;
                        });
                        this[list] = trimList;
          ...
          value: function addTask() {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_11__.__awaiter)(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
              ...
              var aTMOpts, addTaskModal;
              return regeneratorRuntime.wrap(function _callee11$(_context11) {
                while (1) {
                  switch (_context11.prev = _context11.next) {
                    case 0:
                      this.logger.info('[TabTasks|addTask] ()...');
                      aTMOpts = this.addTaskModalOpts;
                      aTMOpts['componentProps'] = {
                        me: this.meObj,
                        my: this.myObj,
                        meAva: this.meAvatar,
                        workAva: this.workAvatar,
                        meEmpId: this.meEmpId,
                        ppl: this.myPpl,
                        myTListLen: this.myTasksToDo.length,
                        assTListLen: this.assTasksAssigned.length
                      };
                      _context11.next = 5;
                      return this.modalCtrl.create(aTMOpts);

                    case 5:
                      addTaskModal = _context11.sent;
                      document.addEventListener('ionModalDidPresent', function () {
                        _this6.addTaskModalOpen = true;

                        _this6.logger.info('[TabTasks|AddTask] (ionModalDidPresent)');
                      });
                      addTaskModal.onWillDismiss().then(function () {
                        _this6.addTaskModalOpen = false;

                        _this6.logger.info('[TabTasks|AddTask] (ionModalWillDismiss)');
                      });
                      addTaskModal.onDidDismiss().then(function (_ref) {
                        var data = _ref.data,
                            role = _ref.role;

                        _this6.logger.info('[TabTasks|AddTask] (ionModalDidDismiss) >>> (Data): ' + data + ' >>> (Role): ' + role);

                        if (role === 'cancel') {
                          _this6.logger.info('[TabTasks|addTask] (CANCELLED) User Cancelled - No Data.');

                          _this6.evServ.showToast('warning', 'Cancelled: Add New Task');
                        } else {
                          var newT = data;

                          _this6.evServ.showToast('success', 'Success: Added Task #' + newT.Id);

                          _this6.formatTask(newT);

                          _this6.sqlServ.insertSingleItem('tasks', newT);

                          _this6.logger.info('[TabTasks|addTask] (Success) Added New Task #' + newT.Id);
                        }
                      });
                      _context11.next = 11;
          ...
          key: "toggleDeleteMode",
          value: function toggleDeleteMode() {
          ...
          key: "deleteTask",
          value: function deleteTask(list, tlI, tO) {
                ...
                while (1) {
                  switch (_context12.prev = _context12.next) {
                    case 0:
                      ...
                      delRes = function delRes(dbRes, apiRes) {
                        var listFns = function listFns() {
                          var trimList = _this7[list].filter(function (t) {
                            return t.Id !== tO.Id;
                          });

                          _this7[list] = trimList;

                          _this7.updateListCounts();
                        };

                        if (dbRes && apiRes) {
                          listFns();

                          _this7.evServ.showToast('success', 'Task Deleted - OK');
                        } else {
                          if (!dbRes && !apiRes) {
                            _this7.evServ.showToast('error', 'Task Delete Errors (DB+API)');
                          } else if (!dbRes && apiRes) {
                            listFns();

                            _this7.evServ.showToast('warning', 'Task Delete Error (DB)');
                          } else {
                            listFns();

                            _this7.evServ.showToast('warning', 'Task Delete Error (API)');
                          }
                        }

                        ;
                        _this7.taskProg = false;
                        jquery__WEBPACK_IMPORTED_MODULE_9__('taskitem-' + tO.Id).removeClass('taskgreyed');
                      };

                      _context12.next = 6;
                      return this.deputy.deleteTask(tO.Id);

                    case 6:
                      delApiRes = _context12.sent;
                      _context12.next = 9;
                      return this.sqlServ.deleteItem('tasks', 'Id', tO.Id);

                    case 9:
                      delDbRes = _context12.sent;
          ...
          key: "toggleReorderList",
          value: function toggleReorderList() {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_11__.__awaiter)(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee13() {
              ...
              var roDis, togDis, i, newList, _i2, compStrOld, compStrNew, _i3, nTO, apiRORes, apiNTO, dbRORes;
                ...
                while (1) {
                  switch (_context13.prev = _context13.next) {
                    case 0:
                      ...
                      roDis = function roDis() {
                        return _this8.tasksReorderGroup.disabled;
                      };

                      togDis = function togDis(v) {
                        _this8.tasksReorderGroup.disabled = v;
                        _this8.tTReorderGroupProps.roDisabled = v;
                      };
                      ...
                      for (i = 0; i < this.myTasksToDo.length; i++) {
                    ...
                    case 13:
                      ...
                      for (_i2 = 0; _i2 < newList.length; _i2++) {
                        this.afterROIds.push(newList[_i2].Id);
                      }

                      ;
                      compStrOld = this.beforeROIds.join(',');
                      console.log(compStrOld);
                      compStrNew = this.afterROIds.join(',');
                    ...
                    case 29:
                      ...
                      nTO = newList[_i3];
                      _context13.next = 33;
                      return this.deputy.reorderTask(this.meEmpId, nTO);

                    case 33:
                      apiRORes = _context13.sent;
                      ...
                      _context13.next = 39;
                      return this.sqlServ.updateTaskSortOrder(apiNTO.Id, apiNTO.SortOrder);

                    case 39:
                      dbRORes = _context13.sent;
                ...
                while (1) {
                  switch (_context14.prev = _context14.next) {
                    case 0:
                      ...
                      for (_i4 = 0; _i4 < this.myTasksToDo.length; _i4++) {
                        this.myTasksToDo[_i4].SortOrder = _i4;
                      }

                      ;
                      this.logger.info('After Reorder: ');

                      for (_i5 = 0; _i5 < this.myTasksToDo.length; _i5++) {
                        aT = this.myTasksToDo[_i5];
                        this.logger.info('[' + _i5 + '] ' + aT.Question + ' - Order: ' + aT.SortOrder);
                      }
          ...
          value: function ionViewWillLeave() {
            this.logger.info('[TabTasks|ionViewWillLeave] ()...');
          } ////////////////////////////////////////////////////////////////////////////////////////
          ...
          value: function ionViewDidLeave() {
            ...
            var titleBar = jquery__WEBPACK_IMPORTED_MODULE_9__('.hcl-leftbar.' + this.tabKey);
            var animBarEnd = jquery__WEBPACK_IMPORTED_MODULE_9__('.sheriff-title-leftanimbar-inner.' + this.tabKey);
            var titleText = jquery__WEBPACK_IMPORTED_MODULE_9__('.sheriff-title.tight-wrap.' + this.tabKey);
          ...
          value: function headerProgress(mode, action, data) {
            ...
            var circProgEle = jquery__WEBPACK_IMPORTED_MODULE_9__('.hcl-progcirc.' + this.tabKey);
            var starEle = jquery__WEBPACK_IMPORTED_MODULE_9__('.hcl-star.' + this.tabKey);
            var sLogoEle = jquery__WEBPACK_IMPORTED_MODULE_9__('.hcl-slogo.' + this.tabKey);

            var startRoutine = function startRoutine() {
              jquery__WEBPACK_IMPORTED_MODULE_9__(sLogoEle).css('transform', 'scale(.9)');
              _this9.progCirc.percent = 0;
              jquery__WEBPACK_IMPORTED_MODULE_9__(starEle).css('transform', 'rotate(0deg)');

              if (jquery__WEBPACK_IMPORTED_MODULE_9__(circProgEle).css('display', 'none')) {
                jquery__WEBPACK_IMPORTED_MODULE_9__(circProgEle).css('display', 'unset');
              }

              _this9.progCirc.animation = false;
              _this9.progCirc.outerStrokeColor = '#FF9800';
            };

            var finishRoutine = function finishRoutine() {
              jquery__WEBPACK_IMPORTED_MODULE_9__(sLogoEle).css('transform', 'unset');
              _this9.progCirc.percent = 100;
              jquery__WEBPACK_IMPORTED_MODULE_9__(starEle).css('transform', 'rotate(0deg)');
              _this9.progCirc.outerStrokeColor = '#4caf50';

              _this9.myAniCSS('.hcl-progcirc.' + _this9.tabKey, 'fadeOut', 0, 1400, 'remove', 'hide');

              _this9.refresher.complete();
            ...
            if (mode === 'timed') {
              ...
              var timedProgLoop = setInterval(function () {
                _this9.progCirc.percent += incPercEaLoop;
                starRotCount += rotStarEaLoop;
                jquery__WEBPACK_IMPORTED_MODULE_9__(starEle).css('transform', 'rotate(' + starRotCount + 'deg)');

                if (_this9.progCirc.percent >= 100) {
          ...
          value: function myAniCSS(theEle, aniName, aniDel, aniDur, aniEnd, eleEnd) {
            ...
            var doAni = function doAni() {
              return new Promise(function (resolve) {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_9__(theEle).on('animationend', function () {
                  if (aniEnd === 'remove') {
      ...
      _TabTasksPage.ctorParameters = function () {
        return [{
      ...
      _TabTasksPage.propDecorators = {
        tasksReorderGroup: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_15__.ViewChild,
          args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_12__.IonReorderGroup, {
            "static": false
          }]
        }],
        tabTasksSegment: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_15__.ViewChild,
          args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_12__.IonSegment, {
            "static": false
          }]
        }],
        tTSegBtnMyTasks: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_15__.ViewChild,
          args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_12__.IonSegmentButton, {
            "static": false
          }]
        }],
        tTSegBtnAssTasks: [{
      ...
      _TabTasksPage = (0, tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_15__.Component)({
        selector: 'app-tabtasks',
        template: _raw_loader_tabtasks_page_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_tabtasks_page_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
      }) ////////////////////////////////////////////////////////////////////////////////////////
      ], _TabTasksPage);
      /***/
    },
