  ...
  (self["webpackChunksheriff"] = self["webpackChunksheriff"] || []).push([["src_app_pay_pay_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PayPageModule": function PayPageModule() {
          return (
            /* binding */
            _PayPageModule
          );
      ...
      var _pay_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./pay.page */
      48941);
      ...
      var _PayPageModule = function PayPageModule() {
        _classCallCheck(this, PayPageModule);
      };

      _PayPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_pay_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./pay.page.html */
      57068);
      /* harmony import */


      var _pay_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./pay.page.scss */
      5013);
      /* harmony import */
      ...
      var _services_deputy_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var _PayPage = /*#__PURE__*/function () {
        ////////////////////////////////////////////////////////////////////////////////////////
        function PayPage(evServ, logger, platform, detailServ, deputy, dT, navCtrl, loadCtrl, menuCtrl, modalCtrl, storeServ, sqlServ, appServ, appRef) {
        ...
        _createClass(PayPage, [{
          ...
          value: function doInitPayments() {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var getPayPeriodRes, getEmpPayCycleRes;
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _context.next = 3;
                      return this.deputy.getPayPeriod();

                    case 3:
                      getPayPeriodRes = _context.sent;
                      ...
                      ;
                      _context.next = 8;
                      return this.deputy.getEmpPayCycle();

                    case 8:
                      getEmpPayCycleRes = _context.sent;
          ...
          value: function ionViewWillLeave() {
            ...
            var titleBar = jquery__WEBPACK_IMPORTED_MODULE_9__('.hcl-leftbar.pay');
            var animBarEnd = jquery__WEBPACK_IMPORTED_MODULE_9__('.sheriff-title-leftanimbar-inner.pay');
            var titleText = jquery__WEBPACK_IMPORTED_MODULE_9__('.sheriff-title.tight-wrap.pay');
          ...
          key: "doPaymentRefresh",
          value: function doPaymentRefresh(event) {
          ...
          value: function pageEnterAnim() {
            ...
            this.evServ.subscribe('doPageEnterAnim', function () {
              ...
              var pageKey = 'pay';
              var sLogoEle = jquery__WEBPACK_IMPORTED_MODULE_9__('.hcl-slogo.' + pageKey);
              var preImg = '../../assets/img/slogo-';
              var cProgEle = jquery__WEBPACK_IMPORTED_MODULE_9__('.hcl-progcirc.' + pageKey);
              var patchEles = jquery__WEBPACK_IMPORTED_MODULE_9__('.hcl-opatch.' + pageKey + ' .hcl-ipatch.' + pageKey);
              var starEle = jquery__WEBPACK_IMPORTED_MODULE_9__('.hcl-star.' + pageKey);
              var pageTitle = jquery__WEBPACK_IMPORTED_MODULE_9__('.hcl-title.' + pageKey);
              var titleBar = jquery__WEBPACK_IMPORTED_MODULE_9__('.hcl-leftbar.' + pageKey);
              var leftCol = jquery__WEBPACK_IMPORTED_MODULE_9__('.sheriff-page-header-col.left-col.' + pageKey);
              var animBarEnd = jquery__WEBPACK_IMPORTED_MODULE_9__('.sheriff-title-leftanimbar-inner.' + pageKey);
              var titleText = jquery__WEBPACK_IMPORTED_MODULE_9__('.sheriff-title.tight-wrap.' + pageKey);
              var calcBarW = Math.round(jquery__WEBPACK_IMPORTED_MODULE_9__(leftCol).outerWidth() + 6 - (jquery__WEBPACK_IMPORTED_MODULE_9__(pageTitle).offset().left + jquery__WEBPACK_IMPORTED_MODULE_9__(pageTitle).outerWidth())) + 'px';
              ...
              setTimeout(function () {
                ...
                setTimeout(function () {
                  ...
                  setTimeout(function () {
                    ...
                    setTimeout(function () {
                      jquery__WEBPACK_IMPORTED_MODULE_9__(titleBar).addClass('dimmed');
                      jquery__WEBPACK_IMPORTED_MODULE_9__(sLogoEle).removeClass('tabtilt');
                    }, 200);
                  }, 200);
                  setTimeout(function () {
                    _this.progCirc.percent = 0;
                    setTimeout(function () {
                      jquery__WEBPACK_IMPORTED_MODULE_9__(cProgEle).css('display', 'unset');
                    }, 1000);
      ...
      _PayPage.ctorParameters = function () {
        return [{
      ...
      _PayPage = (0, tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_13__.Component)({
        selector: 'app-pay',
...
//# sourceMappingURL=src_app_pay_pay_module_ts-es5.js.map